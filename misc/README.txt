...
osTicket uses the git flow development model, so youвЂ™ll need to switch to
...
Русская версия
--------------
Локализованная версия выпускается сайтом osTicket.Ru, в процессе локализации
исправляются найденные ошибки и неточности "стабильной" версии.

Любые вопросы Вы можете задать на нашем форуме http://osticket.ru/forum
Сайт http://osticket.ru